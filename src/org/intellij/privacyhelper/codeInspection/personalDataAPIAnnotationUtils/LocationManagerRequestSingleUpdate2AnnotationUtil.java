 ...
 */
public class LocationManagerRequestSingleUpdate2AnnotationUtil extends PersonalDataAPIAnnotationUtil {
    ...
    public AnnotationHolder createAnnotationInferenceFromSource(PsiElement source) {
        ...
        if (sourceMethodCallExp == null || sourceMethodCallExp.getArgumentList().getExpressions().length <= 0) {
            return annotationHolder;
        }
        PsiExpression criteria = sourceMethodCallExp.getArgumentList().getExpressions()[0];
