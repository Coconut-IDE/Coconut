...
/**
 * Created by tiffany on 3/31/19.
 */
public class ContactsAnnotationUtil extends PersonalDataAPIAnnotationUtil {
    @Override
    public AnnotationHolder createAnnotationInferenceFromSource(PsiElement source) {
        ...
        AnnotationHolder annotationHolder = CodeInspectionUtil.createEmptyAnnotationHolderByType(CoconutAnnotationType.ContactsAnnotation);
        ...
        if (methodCallExpression.getArgumentList().getExpressions().length > 1
            ...
            if (projection instanceof PsiReferenceExpression) {
                ...
                throw new RuntimeException("Projection field of Contacts query defined in a way not currently handled");
            }
            ...
            if (projectionString instanceof PsiNewExpressionImpl) {
                ...
                if (initializerExpression != null) {
                    ...
                    QueryUtils.updateContactsDataTypeSpeculationsFromStringList(projectionArray, dataTypeSpeculations);
                }
            }
        }
        ...
        if (methodCallExpression.getArgumentList().getExpressions().length > 2
            ...
            if (selection instanceof PsiReferenceExpression) {
                ...
                throw new RuntimeException("Selection field of Contacts query defined in a way not currently handled");
            }

            QueryUtils.updateContactsDataTypeSpeculationsFromStringList(selectionArray, dataTypeSpeculations);
        }
