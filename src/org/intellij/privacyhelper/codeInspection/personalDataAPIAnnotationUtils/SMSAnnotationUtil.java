 ...
 */
public class SMSAnnotationUtil extends PersonalDataAPIAnnotationUtil {
    @Override
    public AnnotationHolder createAnnotationInferenceFromSource(PsiElement source) {
        ...
        AnnotationHolder annotationHolder = CodeInspectionUtil.createEmptyAnnotationHolderByType(CoconutAnnotationType.SMSAnnotation);
        ...
        if (methodCallExpression.getArgumentList().getExpressions().length > 1
            ...
            if (projection instanceof PsiReferenceExpression) {
                ...
                throw new RuntimeException("Projection field of SMS query defined in a way not currently handled");
            }
            ...
            if (projectionString instanceof PsiNewExpressionImpl) {
                ...
                if (initializerExpression != null) {
                    ...
                    QueryUtils.updateSmsDataTypeSpeculationsFromStringList(projectionArray, dataTypeSpeculations);
                }
            }
        }
        ...
        if (methodCallExpression.getArgumentList().getExpressions().length > 2
            ...
            if (selection instanceof PsiReferenceExpression) {
                ...
                throw new RuntimeException("Selection field of SMS query defined in a way not currently handled");
            }

            QueryUtils.updateSmsDataTypeSpeculationsFromStringList(selectionArray, dataTypeSpeculations);
        }
