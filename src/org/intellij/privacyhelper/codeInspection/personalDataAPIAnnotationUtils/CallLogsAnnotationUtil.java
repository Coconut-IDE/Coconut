...
/**
 * Created by tiffany on 5/18/19.
 */


public class CallLogsAnnotationUtil extends PersonalDataAPIAnnotationUtil {
    @Override
    public AnnotationHolder createAnnotationInferenceFromSource(PsiElement source) {
        ...
        AnnotationHolder annotationHolder = CodeInspectionUtil.createEmptyAnnotationHolderByType(CoconutAnnotationType.CallLogsAnnotation);
        ...
        if (methodCallExpression.getArgumentList().getExpressions().length > 1
            ...
            if (projection instanceof PsiReferenceExpression) {
                ...
                throw new RuntimeException("Projection field of Call logs query defined in a way not currently handled");
            }
            ...
            if (projectionString instanceof PsiNewExpressionImpl) {
                ...
                if (initializerExpression != null) {
                    ...
                    QueryUtils.updateCallLogsDataTypeSpeculationsFromStringList(projectionArray, dataTypeSpeculations);
                }
            }
        }
        ...
        if (methodCallExpression.getArgumentList().getExpressions().length > 2
            ...
            if (selection instanceof PsiReferenceExpression) {
                ...
                throw new RuntimeException("Selection field of Call logs query defined in a way not currently handled");
            }

            QueryUtils.updateCallLogsDataTypeSpeculationsFromStringList(selectionArray, dataTypeSpeculations);
        }
