...
public class NavigateToCodeQuickfix implements LocalQuickFix {
    ...
    private String JUMP_TO_CODE_QUICKFIX_NAME;
    private SmartPsiElementPointer targetElementPointer;

    public NavigateToCodeQuickfix(SmartPsiElementPointer targetElementPointer, String targetDescription) {
