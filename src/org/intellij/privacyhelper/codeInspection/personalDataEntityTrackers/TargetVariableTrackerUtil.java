...
public class TargetVariableTrackerUtil {
    static PsiClass getCallbackContainingClass(PsiElement source, int listenerParameterPosition) {
        ...
        PsiExpression listenerExpression = expression.getArgumentList().getExpressions()[listenerParameterPosition];
     ...
     *
     * This method was originally used but only accounted for data for callbacks with one parameter.
     * It is now re-routed to a method that accounts for multiple parameters
     *
     ...
     */
    @Deprecated
    static PsiElement getDataEntityFromClass(PsiClass psiClass, String targetListenerType, String callbackName) {
        return getDataEntityFromClass(psiClass, targetListenerType, callbackName, 0);
    }
    ...
    public static PsiElement getResolvedVariable(PsiElement element) {
        ...
        } else if (PsiTreeUtil.getParentOfType(element, PsiLocalVariable.class) != null) {
        ...
        } else if (PsiTreeUtil.getParentOfType(element, PsiAssignmentExpression.class) != null) {
